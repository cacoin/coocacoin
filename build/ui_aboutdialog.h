...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About ChinafricaCoin", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("AboutDialog", "<html><head/><body><p>ChinafricaCoin version</p></body></html>", 0, QApplication::UnicodeUTF8));
