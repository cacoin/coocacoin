...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "ChinafricaCoin - Debug window", 0, QApplication::UnicodeUTF8));
        ...
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "<html><head/><body><p>Show the ChinafricaCoin-Qt help message to get a list with possible ChinafricaCoin command-line options.</p></body></html>", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        ...
        label_9->setText(QApplication::translate("RPCConsole", "ChinafricaCoin Core", 0, QApplication::UnicodeUTF8));
        label_4->setText(QApplication::translate("RPCConsole", "Estimated total blocks", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "<html><head/><body><p>Open the ChinafricaCoin debug log file from the current data directory. This can take a few seconds for large log files.</p></body></html>", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
